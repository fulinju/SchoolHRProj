...
function(e, t) {
	...
	e.DtPicker = e.Class.extend({
		...
		_create: function(e) {
			var t = this;
			e = e || {}, e.labels = e.labels || ["年", "月", "日", LangRes.Prop('Hour'), LangRes.Prop('Min')], e.buttons = e.buttons || [LangRes.Prop('Cancel'), LangRes.Prop('Sure')], e.type = e.type || "datetime", e.customData = e.customData || {}, t.options = e;
			var i = new Date,
				n = e.beginDate;
