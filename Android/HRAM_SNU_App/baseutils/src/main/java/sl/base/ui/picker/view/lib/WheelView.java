package sl.base.ui.picker.view.lib;
...
import sl.base.R;
import sl.base.ui.picker.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    private void initPaints() {
        ...
        int desTextSize = textSize;
        paintCenterText.setTextSize(desTextSize); //字体大小
    ...
    public final void setTextSize(float size) {
        if (size > 0.0F) {
            textSize = (int) (context.getResources().getDisplayMetrics().density * size / 10 * 9);//9/10
            paintOuterText.setTextSize(textSize);
