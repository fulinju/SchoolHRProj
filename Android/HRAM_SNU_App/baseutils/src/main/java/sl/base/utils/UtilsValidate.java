...
public class UtilsValidate {
     ...
     * 正则表达式：验证密码 3 - 18 位
     */
    public static final String REGEX_PASSWORD = "^[a-zA-Z0-9]{2,16}$";
     ...
     * 正则表达式：验证URL
     */
    public static final String REGEX_URL = "^(((file|gopher|news|nntp|telnet|http|ftp|https|ftps|sftp)://)|(www\\.))+" +
