...
import sl.base.R;
import sl.base.ui.picker.listener.OnDismissListener;
import sl.base.ui.picker.utils.PickerViewAnimateUtil;
...
public class BasePickerView
{
	...
	public void show()
	{
		if(judgeTimeInAccept()){
			...
			Toast.makeText(context, context.getString(R.string.pickerView_overtime),Toast.LENGTH_SHORT).show();
		}
	}
