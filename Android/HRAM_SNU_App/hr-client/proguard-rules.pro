...
#实体类
-dontwarn sl.hr_client.data.**
-keep class sl.hr_client.data.** { *; }

##通用UI
-dontwarn sl.base.ui.**
-keep class sl.base.ui.** { *; }

##我的通用包
-dontwarn sl.base.utils.**
-keep class sl.base.utils.** { *; }
...
#-keepclassmembers class * extends org.greenrobot.greendao.database.AbstractDao {
