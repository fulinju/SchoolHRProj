...
public class MemberModel {
    ...
    public Observable<String> getMembers(final Context context, final int pageIndex, final int pageSize) {
        return Observable.create(new Observable.OnSubscribe<String>() {
            @Override
            public void call(final Subscriber<? super String> subscriber) {
                String targetUrl = VolleyUtils.membersUrl + "?pageIndex=" + pageIndex + "&pageSize="+pageSize;
