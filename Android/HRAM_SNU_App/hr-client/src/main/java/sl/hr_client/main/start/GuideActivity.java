...
public class GuideActivity extends BaseActivity implements View.OnClickListener{
    ...
    // 引导页图片资源
    private static final int[] pics = {R.layout.layout_guide_0, R.layout.layout_guide_1, R.layout.layout_guide_end
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < pics.length; i++) {
            ...
            if (i == pics.length - 1) {
                startBtn = (Button) view.findViewById(R.id.btn_start_now);
                startBtn.setTag("enter"); //Tag方式判断点击哪一个
